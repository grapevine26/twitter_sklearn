...
##########################
reviews_train = []
for line in open('tweet_data2/tweet_train.txt', 'r', encoding='UTF-8'):
	reviews_train.append(line.strip())

reviews_test = []
for line in open('tweet_data2/tweet_test.txt', 'r', encoding='UTF-8'):
...
##############################
pos = []
y_predict = final.decision_function(X_test[:12500])
for i in y_predict:
	if i > 0:
		pos.append(i)
...
# 파일에 저장
joblib.dump(ngram_vectorizer, 'tweet_vect.pkl')
joblib.dump(final, 'tweet_model.pkl')
#
# 불러오기
